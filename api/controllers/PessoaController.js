  ...
  static async pegaMatriculaPorTurma(req, res) {
    ...
    try {
      const todasAsMatriculas = await database.Matriculas.findAndCountAll({
        ...
        limit: 20, //limita o numero de coisas que vão ser imprimidas
        order: [['estudandte_id', 'ASC']] //PRIMERIO É A COLUNA E A SEGUNDA É A ORDEM QUE VC QUER QUE ESSA COLUNA SEJA IMPRIMIDA ASC E DESC
      })
